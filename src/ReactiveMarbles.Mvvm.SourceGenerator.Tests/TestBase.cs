...
// }}";
//
//             return TestHelper.TestPass<TSourceGenerator>(source, contractParameter, GetType());
//         }
//
//         [Theory]
//         [InlineData("")]
...
// }}";
//
//             return TestHelper.TestFail<TSourceGenerator>(source, contractParameter, GetType());
//         }
//
//         [Theory]
//         [InlineData("")]
