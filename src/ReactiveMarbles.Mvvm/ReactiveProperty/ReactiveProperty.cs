...
public class ReactiveProperty<T> : RxDisposableObject, IReactiveProperty<T>
{
    ...
    public ReactiveProperty()
        : this(default, TaskPoolScheduler.Default, false, false)
    {
    }
    ...
    public ReactiveProperty(T? initialValue)
        : this(initialValue, TaskPoolScheduler.Default, false, false)
    {
    }
    ...
    public ReactiveProperty(T? initialValue, bool skipCurrentValueOnSubscribe, bool allowDuplicateValues)
        : this(initialValue, TaskPoolScheduler.Default, skipCurrentValueOnSubscribe, allowDuplicateValues)
    {
    }
    ...
    public ReactiveProperty<T> AddValidationError(Func<IObservable<T?>, IObservable<IEnumerable?>> validator, bool ignoreInitialError = false)
    {
        ...
        _validationDisposable.Disposable = Observable
            ...
            .Subscribe(x =>
            {
                ...
                {
                    _scheduler.Schedule(() => RaisePropertyChanged(SingletonPropertyChangedEventArgs.HasErrors.PropertyName!));
                }
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Roslynator", "RCS1163:Unused parameter", Justification = "Required for interface.")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE0060:Remove unused parameter", Justification = "Required for interface.")]
